...
exports.Decimal = toformat_1.default(decimal_js_light_1.default);
// eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
exports.Big = toformat_1.default(big_js_1.default);
...
class Fraction {
    constructor(numerator, denominator = jsbi_1.default.BigInt(1)) {
        ...
        this.numerator = jsbi_1.default.BigInt(utils_1.parseBigintIsh(numerator));
        this.denominator = jsbi_1.default.BigInt(utils_1.parseBigintIsh(denominator));
    }
    /**
    ...
    static tryParseFraction(fractionish) {
        ...
        try {
            return new Fraction(utils_1.parseBigintIsh(fractionish));
        }
        catch (e) {
