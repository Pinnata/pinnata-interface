...
class TokenAmount extends fraction_1.Fraction {
    ...
    add(other) {
        tiny_invariant_1.default(this.token.equals(other.token), `add token mismatch: ${this.token.toString()} !== ${other.token.toString()}`);
        return new TokenAmount(this.token, jsbi_1.default.add(this.raw, other.raw));
    }
    subtract(other) {
        tiny_invariant_1.default(this.token.equals(other.token), `subtract token mismatch: ${this.token.toString()} !== ${other.token.toString()}`);
    ...
    divideByAmount(other) {
        tiny_invariant_1.default(this.token.equals(other.token), `divideByAmount token mismatch: ${this.token.toString()} !== ${other.token.toString()}`);
