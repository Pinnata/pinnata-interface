...
import { IClient, ISession, SessionTypes, SubscriptionEvent, CryptoTypes } from "@walletconnect/types";
...
export declare class Session extends ISession {
    ...
    protected onUpgrade(payloadEvent: SubscriptionEvent.Payload): Promise<void>;
    protected handleUpdate(topic: string, params: SessionTypes.Update, participant: CryptoTypes.Participant): Promise<SessionTypes.Update>;
    protected handleUpgrade(topic: string, params: SessionTypes.Upgrade, participant: CryptoTypes.Participant): Promise<SessionTypes.Upgrade>;
