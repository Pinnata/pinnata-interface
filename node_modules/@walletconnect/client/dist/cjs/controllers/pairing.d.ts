...
import { PairingTypes, IClient, IPairing, SubscriptionEvent, CryptoTypes } from "@walletconnect/types";
...
export declare class Pairing extends IPairing {
    ...
    protected handleUpdate(topic: string, params: PairingTypes.Update, participant: CryptoTypes.Participant): Promise<PairingTypes.Update>;
    protected handleUpgrade(topic: string, params: PairingTypes.Upgrade, participant: CryptoTypes.Participant): Promise<PairingTypes.Upgrade>;
