...
export declare class WalletConnectWallet extends RemoteWallet<WalletConnectSigner> {
    ...
    onPairingCreated: (pairing: import("@walletconnect/types").SequenceTypes.Created<any, import("@walletconnect/types").SequenceTypes.Participant, import("@walletconnect/types").SequenceTypes.SettledPermissions>) => void;
