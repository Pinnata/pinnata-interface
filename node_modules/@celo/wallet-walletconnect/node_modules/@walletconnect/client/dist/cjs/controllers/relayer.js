...
const ws_connection_1 = require("@json-rpc-tools/ws-connection");
...
class Relayer extends types_1.IRelayer {
    ...
    publish(topic, payload, opts) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const message = hasKeys ? yield this.client.crypto.encrypt(topic, msg) : enc_utils_1.utf8ToHex(msg);
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                this.events.on(id, ({ message }) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                    const hasKeys = yield this.client.crypto.hasKeys(topic);
                    const payload = safe_json_utils_1.safeJsonParse(hasKeys ? yield this.client.crypto.decrypt(topic, message) : enc_utils_1.hexToUtf8(message));
                    listener(payload);
                }));
    ...
    setProvider(provider) {
        ...
        return typeof provider !== "string" && typeof provider !== "undefined"
            ? provider
            : new provider_1.JsonRpcProvider(new ws_connection_1.WsConnection(rpcUrl));
    }
