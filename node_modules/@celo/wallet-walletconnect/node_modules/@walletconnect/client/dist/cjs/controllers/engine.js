...
class Engine extends types_1.IEngine {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (utils_2.isJsonRpcRequest(payload)) {
                if (!Object.values(this.sequence.config.jsonrpc).includes(payload.method)) {
                    ...
                    payload = utils_2.formatJsonRpcRequest(this.sequence.config.jsonrpc.payload, params, payload.id);
                }
            }
            else {
    ...
    update(params) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const request = utils_2.formatJsonRpcRequest(this.sequence.config.jsonrpc.update, update);
    ...
    upgrade(params) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const request = utils_2.formatJsonRpcRequest(this.sequence.config.jsonrpc.upgrade, upgrade);
            yield this.send(settled.topic, request);
            return settled;
        });
    }
    ...
    notify(params) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const request = utils_2.formatJsonRpcRequest(this.sequence.config.jsonrpc.notification, notification);
    ...
    onAcknowledge(payloadEvent) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (!utils_1.isSequenceResponded(pending))
                return;
            if (utils_2.isJsonRpcError(response) && !utils_1.isSequenceFailed(pending.outcome)) {
            ...
            if (utils_2.isJsonRpcRequest(payload)) {
                ...
                switch (request.method) {
                    ...
                    case this.sequence.config.jsonrpc.ping:
                        yield this.send(settled.topic, utils_2.formatJsonRpcResult(request.id, true));
                        break;
                    default:
                        error = utils_1.ERROR.UNKNOWN_JSONRPC_METHOD.format({ method: request.method });
                        this.sequence.logger.error(error.message);
                        yield this.send(settled.topic, utils_2.formatJsonRpcError(request.id, error));
                        break;
                }
            }
            else {
    ...
    onPendingStatusEvent(event) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (utils_1.isSequenceResponded(pending)) {
                ...
                this.sequence.events.emit(eventName, pending);
                if (utils_1.isSignalTypePairing(pending.proposal.signal)) {
                    const request = utils_2.formatJsonRpcRequest(this.sequence.config.jsonrpc.propose, pending.proposal);
    ...
    registerEventListeners() {
        ...
        this.sequence.settled.on(constants_1.SUBSCRIPTION_EVENTS.deleted, (deletedEvent) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const request = utils_2.formatJsonRpcRequest(this.sequence.config.jsonrpc.delete, { reason });
