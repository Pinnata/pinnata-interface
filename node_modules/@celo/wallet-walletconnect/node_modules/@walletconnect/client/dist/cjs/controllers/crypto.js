...
class Crypto {
    ...
    concatKeys(keyA, keyB) {
        return enc_utils_1.arrayToHex(enc_utils_1.concatArrays(enc_utils_1.hexToArray(keyA), enc_utils_1.hexToArray(keyB)));
    }
    splitKeys(keys) {
        const arr = enc_utils_1.hexToArray(keys);
        return [enc_utils_1.arrayToHex(arr.slice(0, 32)), enc_utils_1.arrayToHex(arr.slice(32, 64))];
    }
    setKeyPair(keyPair) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
