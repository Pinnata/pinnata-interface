...
var loadPreviousConfig = function () {
    var _a;
    var _b;
    var lastUsedNetworkName = constants_1.CeloMainnet.name;
    ...
    var lastUsedNetwork = (_b = constants_1.DEFAULT_NETWORKS.find(function (n) { return n.name === lastUsedNetworkName; })) !== null && _b !== void 0 ? _b : constants_1.CeloMainnet;
