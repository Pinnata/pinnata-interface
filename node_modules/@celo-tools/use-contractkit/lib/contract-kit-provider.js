...
var initialState = {
    connector: new connectors_1.UnauthenticatedConnector(constants_1.CeloMainnet),
    ...
    network: constants_1.CeloMainnet,
    networks: constants_1.DEFAULT_NETWORKS,
    pendingActionCount: 0,
    address: null,
    connectionCallback: null,
};
exports.useContractKitContext = (_a = createContractKitContext(), _a[0]), exports.ContextProvider = _a[1];
...
var ContractKitProvider = function (_a) {
    var _b;
    var children = _a.children, connectModal = _a.connectModal, actionModal = _a.actionModal, dapp = _a.dapp, _c = _a.network, network = _c === void 0 ? constants_1.CeloMainnet : _c, _d = _a.networks, networks = _d === void 0 ? constants_1.DEFAULT_NETWORKS : _d;
    var isMountedRef = useIsMounted_1.useIsMounted();
    var previousConfig = react_1.useMemo(helpers_1.loadPreviousConfig, []);
    var _e = react_1.useReducer(contract_kit_reducer_1.contractKitReducer, __assign(__assign(__assign({}, initialState), previousConfig), { network: network, networks: networks, dapp: __assign(__assign({}, dapp), { icon: (_b = dapp.icon) !== null && _b !== void 0 ? _b : dapp.url + "/favicon.ico" }) })), state = _e[0], _dispatch = _e[1];
    ...
    var methods = use_contract_kit_methods_1.useContractKitMethods(state, dispatch);
