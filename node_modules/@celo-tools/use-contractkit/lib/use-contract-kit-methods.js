...
function useContractKitMethods(_a, dispatch) {
    ...
    var initConnector = react_1.useCallback(function (nextConnector) { return __awaiter(_this, void 0, void 0, function () {
        var initialisedConnector, netId_1, newNetwork, e_1, error;
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    initialisedConnector = _c.sent();
                    dispatch('initialisedConnector', initialisedConnector);
                    return [4 /*yield*/, initialisedConnector.kit.web3.eth.net.getId()];
                case 2:
                    netId_1 = _c.sent();
                    ...
                    // accordingly.
                    (_a = initialisedConnector.onNetworkChange) === null || _a === void 0 ? void 0 : _a.call(initialisedConnector, function (chainId) {
                    ...
                    (_b = initialisedConnector.onAddressChange) === null || _b === void 0 ? void 0 : _b.call(initialisedConnector, function (address) {
                        dispatch('setAddress', address);
                    });
                    return [2 /*return*/, initialisedConnector];
                case 3:
                    e_1 = _c.sent();
    ...
    var updateNetwork = react_1.useCallback(function (newNetwork) { return __awaiter(_this, void 0, void 0, function () {
        var connectorArgs, ConnectorConstructor, newConnector;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (constants_1.STATIC_NETWORK_WALLETS.includes(connector.type)) {
                        return [2 /*return*/, console.error("The connected wallet's network must be changed from the wallet.")];
                    }
                ...
                case 1:
                    ...
                    newConnector = new (ConnectorConstructor.bind.apply(ConnectorConstructor, __spreadArray([void 0, newNetwork], connectorArgs)))();
    ...
    var performActions = react_1.useCallback(function () {
        ...
        return __awaiter(_this, void 0, void 0, function () {
            var kit, results, _a, operations_1, op, _b, _c, e_2;
