...
exports.DEFAULT_NETWORKS = exports.getProviderForWallet = exports.STATIC_NETWORK_WALLETS = exports.WalletTypes = exports.Kovan = exports.EthereumMainnet = exports.CeloMainnet = exports.Baklava = exports.Alfajores = exports.NetworkNames = exports.images = exports.PROVIDERS = exports.SupportedProviders = exports.localStorageKeys = void 0;
...
(function (SupportedProviders) {
    ...
    SupportedProviders["Injected"] = "Ethereum Web3";
    SupportedProviders["Ledger"] = "Ledger";
    SupportedProviders["MetaMask"] = "MetaMask";
    SupportedProviders["imToken"] = "imToken";
...
exports.PROVIDERS = (_a = {},
    ...
    _a[SupportedProviders.MetaMask] = {
        name: 'MetaMask',
        description: react_device_detect_1.isMobile ? ('Open Ubeswap in your Metamask app') : (react_1.default.createElement(react_1.default.Fragment, null,
    ...
    _a[SupportedProviders.imToken] = {
        name: 'imToken',
        description: ((_c = window.ethereum) === null || _c === void 0 ? void 0 : _c.isImToken) ? ('Open Ubeswap in your imToken app') : (react_1.default.createElement(react_1.default.Fragment, null, "Connect with imToken")),
        icon: walletIcons_1.IMTOKEN,
        canConnect: function () { var _a; return !!((_a = window.ethereum) === null || _a === void 0 ? void 0 : _a.isImToken); },
        showInList: function () { return react_device_detect_1.isMobile; },
    ...
    _a[SupportedProviders.Injected] = {
        ...
        showInList: function () { return !!window.ethereum; },
        // Prioritize if window.ethereum is present but MetaMask is not
        listPriority: function () {
            var _a, _b;
            return window.ethereum &&
                !((_a = window.ethereum) === null || _a === void 0 ? void 0 : _a.isMetaMask) &&
                !((_b = window.ethereum) === null || _b === void 0 ? void 0 : _b.isImToken)
                ? 0
                : 1;
        },
    },
...
(function (NetworkNames) {
    ...
    NetworkNames["CeloMainnet"] = "CeloMainnet";
    NetworkNames["EthereumMainnet"] = "EthereumMainnet";
...
exports.CeloMainnet = {
    ...
    chainId: types_1.ChainId.CeloMainnet,
};
exports.EthereumMainnet = {
    ...
    chainId: types_1.ChainId.EthereumMainnet,
};
exports.Kovan = {
    name: NetworkNames.Kovan,
    rpcUrl: process.env.KOVAN_RPC_URL || process.env.REACT_APP_KOVAN_RPC_URL || '',
    graphQl: 'https://blockscout.com/eth/mainnet/graphiql',
    explorer: 'https://kovan.etherscan.io',
    chainId: types_1.ChainId.Kovan,
};
var WalletTypes;
 ...
 */
exports.STATIC_NETWORK_WALLETS = [
