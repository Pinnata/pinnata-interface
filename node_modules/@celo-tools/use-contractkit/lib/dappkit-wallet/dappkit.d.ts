...
export declare const valoraLocalStorageKey = "use-contractkit/dappkit";
...
export declare function requestTxSig(kit: ContractKit, txParams: CeloTx[], meta: DappKitRequestMeta): Promise<void>;
//# sourceMappingURL=dappkit.d.ts.map