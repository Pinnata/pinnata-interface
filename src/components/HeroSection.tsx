        ...
        <section className="relative">
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                ...
                <div className="pt-32 pb-12 md:pt-40 md:pb-20">
                    ...
                    <h1 className="text-5xl md:text-6xl font-extrabold leading-tighter tracking-tighter mb-4" data-aos="zoom-y-out">Cross-chain leveraged yield farming protocol on <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-700 to-green-400">Celo</span></h1>
                    <div className="max-w-3xl mx-auto pb-9 pt-9">
                        ...
                        <div className="px-2">
                            <Link to='/earn' >
                                <button className="from-blue-700 to-green-300 text-white border-blue-700 bg-gradient-to-r hover:to-blue-700 hover:from-green-300 hover:text-white active:bg-blue-700 font-bold uppercase px-8 py-3 rounded-full outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" onClick={() => {
                                history.push('/earn')
                                    }}>Launch App</button>
                            </Link>
                        </div>
